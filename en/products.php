      ...
      <div hidden class="col-lg-4 col-md-6">
        <div class="card product-card shadow-sm h-100">
          ...
          <div class="card-body text-center">
            ...
            <p class="card-text">Distinctive OR Cafee coffee with its rich and authentic flavor</p>
          </div>
        </div>
      </div>
  ...
  <!-- Thirst -->
      ...
      <div hidden class="col-lg-4 col-md-6">
        <div class="card product-card shadow-sm h-100">
          ...
          <div class="card-body text-center">
            ...
            <p class="card-text">Refreshing and iced Frappe beverages</p>
          </div>
        </div>
      </div>
      ...
      <div hidden class="col-lg-4 col-md-6">
        <div class="card product-card shadow-sm h-100">
          ...
          <div class="card-body text-center">
            ...
            <p class="card-text">High-quality authentic Japanese Matcha tea</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-6">
        <div class="card product-card shadow-sm h-100">
          ...
          Hario 02 white paper filters, 100 pieces
      ...
      <div class="col-lg-4 col-md-6">
        <div class="card product-card shadow-sm h-100">
          ...
          <div class="card-body text-center">
            <h5 class="card-title">Bun Filters</h5>
            <p class="card-text">High-quality Bun products </p>
          </div>
        </div>
      </div>
